...
struct Question {
  ...
  Question questions[] = {
      ...
      {
        .question = "\nQuestion 3. \nif(data[i] >= count){  simbol Flowchart yang di gunakan "
      ...
      {
      	.question = "\nQuestion 4. \nDalam c++ tersedia function untuk memeriksa kondisi - kondisi pada operasi file, "
      				"sehingga kesalahan saat eksekusi dapat dikendalikan. Function yang dimaksud adalah? ",
        .choiceA = "Open()",
        .choiceB = "Put()",
        .choiceC = "Get()",
        .choiceD = "Fail()",
  ...
  // melakukan perulangan sampai jumlah soalnya
   ...
   system("cls");
    gotoxy(24, 12); cout << "C O N G R A T U L A T I O N ! " << std::endl;
    gotoxy(24, 13); cout << 	"You Played Very Well!!!!!!" << endl;
    printf("\n			==========================================================================\n", 16);
